...
import { ProjectFormData, ColorOption } from '../types';
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-background-800/95 backdrop-blur-xl border border-background-700/50 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-300">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-120px)]">
            ...
            {/* AI Project Description - Primary Field */}
            <div className="space-y-3">
              <label className="flex items-center gap-2 text-sm font-semibold text-secondary-300 tracking-wide uppercase">
              ...
              <div className="space-y-2">
                <textarea
                  ...
                  disabled={isSubmitting}
                  rows={4}
                  className="w-full px-4 py-3 border border-purple-500/30 bg-purple-500/5 rounded-lg focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-300 resize-none text-white placeholder-secondary-500 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  placeholder="Describe your project in detail for AI to generate phases and tasks automatically. e.g., 'A mobile e-commerce app for selling vintage clothing with user accounts, product catalog, shopping cart, and payment processing...'"
                  maxLength={500}
                />
                <div className="flex items-center justify-between">
                  <div className="text-xs text-purple-400 font-medium">
                    ✨ AI will automatically create phases and tasks based on this description
                  </div>
                  <div className="text-xs text-secondary-500">
                    {formData.aiPrompt?.length || 0}/500 characters
                  </div>
                </div>
              </div>
            </div>
