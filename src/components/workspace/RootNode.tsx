...
import { type RootNode as RootNodeType } from '@/types';

const RootNode: React.FC<NodeProps<RootNodeType>> = ({ data, selected}) => {
  ...
  const getMainNodeStyle = (
    ...
    const baseStyle: React.CSSProperties = {
      ...
      minWidth: '180px',
      boxShadow:
        '0 20px 40px rgba(20, 184, 166, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1) inset',
    ...
    if (isSelected) {
      return {
        ...
        boxShadow:
          '0 0 0 4px rgba(45, 212, 191, 0.3), 0 20px 40px rgba(20, 184, 166, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.1) inset',
      };
    }
