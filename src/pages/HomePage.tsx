...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    const project = getLocalProject({ isGuest: true });
    if (project) {
      navigate(`/guest/${project.id}}`);
    }
  }, []);
  ...
  const handleStartProject = async () => {
    ...
    try {
      ...
      if (res?.newEdges && res.newNodes)
        saveLocalProject(
          { nodes: res.newNodes, edges: res.newEdges },
          { isGuest: true }
        );

      navigate(`/guest/${guestProject.id}`);
    } catch (error) {
        ...
        <div className='relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12'>
          ...
          <div className='text-center mb-10 sm:mb-12'>
            ...
            <p className='text-lg text-secondary-400 max-w-2xl mx-auto leading-relaxed'>
              Describe your goal in plain English. Our AI will generate a
              complete project structure with phases and tasks, visualized as an
              interactive mind map.
            </p>
          </div>
          {/* AI Prompt CTA - Clean and minimal */}{' '}
          <div className='bg-background-800/40 backdrop-blur-xl border border-background-700/30 rounded-xl shadow-lg mb-10 sm:mb-12 relative overflow-hidden'>
              ...
              <div className='flex items-center gap-3 mb-6'>
                ...
                <div>
                  ...
                  <p className='text-sm text-secondary-400'>
                    AI will generate your project structure
                  </p>
                </div>
              </div>
          ...
          <div className='mb-10 sm:mb-12'>
            <div className='text-center mb-6 sm:mb-8'>
              ...
              <p className='text-secondary-400 max-w-xl mx-auto'>
                Everything you need to plan, organize, and execute your projects
                efficiently
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
              <div className='bg-background-800/40 backdrop-blur-xl border border-background-700/30 rounded-xl p-5 shadow-lg relative overflow-hidden'>
                ...
                <div className='relative'>
                  ...
                  <p className='text-secondary-400 leading-relaxed text-sm'>
                    Visualize your entire project from a single idea. Let AI
                    build the structure for you with intelligent node placement.
                  </p>
                </div>
              </div>
              ...
              <div className='bg-background-800/40 backdrop-blur-xl border border-background-700/30 rounded-xl p-5 shadow-lg relative overflow-hidden'>
                ...
                <div className='relative'>
                  ...
                  <h4 className='text-lg font-bold text-white mb-2'>
                    Seamless Kanban Workflow
                  </h4>
                  <p className='text-secondary-400 leading-relaxed text-sm'>
                    Automatically convert your mind map into an actionable
                    kanban board to track progress and manage tasks.
                  </p>
                </div>
              </div>
              ...
              <div className='bg-background-800/40 backdrop-blur-xl border border-background-700/30 rounded-xl p-5 shadow-lg relative overflow-hidden'>
                ...
                <div className='relative'>
                  ...
                  <p className='text-secondary-400 leading-relaxed text-sm'>
                    Sign up to save, share, and collaborate on projects with
                    your team in real-time with live updates.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-background-800/40 backdrop-blur-xl border border-background-700/30 rounded-xl p-5 sm:p-6 shadow-lg relative overflow-hidden'>
              ...
              <div className='relative'>
                ...
                <p className='text-secondary-400 mb-5 max-w-md mx-auto text-sm'>
                  Create your first project above, or sign in to access the full
                  suite of collaborative features.
                </p>
                <button
                  onClick={handleSignIn}
